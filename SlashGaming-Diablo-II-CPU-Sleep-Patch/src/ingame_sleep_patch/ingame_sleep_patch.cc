...
#include "ingame_sleep_patch_1_11.hpp"
#include "ingame_sleep_patch_1_11b.hpp"
#include "ingame_sleep_patch_1_12a.hpp"
#include "ingame_sleep_patch_1_13a_beta.hpp"
...
#include "ingame_sleep_patch_classic_1_14d.hpp"
...
std::vector<mapi::GamePatch> MakeIngameSleepPatches() {
  switch (d2::GetRunningGameVersionId()) {
    ...
    case d2::GameVersion::k1_11: {
      return MakeIngameSleepPatches_1_11();
    }

    case d2::GameVersion::k1_11B: {
      return MakeIngameSleepPatches_1_11B();
    }

    case d2::GameVersion::k1_12A: {
      return MakeIngameSleepPatches_1_12A();
    }

    case d2::GameVersion::k1_13ABeta: {
      return MakeIngameSleepPatches_1_13ABeta();
    }
    ...
    case d2::GameVersion::kClassic1_14A: {
      return MakeIngameSleepPatches_Classic1_14A();
    }
    ...
    case d2::GameVersion::kClassic1_14D: {
      return MakeIngameSleepPatches_Classic1_14D();
    }
